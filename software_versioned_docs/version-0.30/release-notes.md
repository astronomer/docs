...
- You can now configure `kubernetes_apiservers_insecure_skip_verify` in the Prometheus Helm chart.
- You can now set `certgenerator.extraAnnotations` in the Airflow Helm chart.
