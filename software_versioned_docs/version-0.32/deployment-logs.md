...
The Software UI allows you to look up and search Apache Airflow® logs emitted by your webserver, scheduler, worker(s), and git-sync Pods for any Deployment you have access to.
