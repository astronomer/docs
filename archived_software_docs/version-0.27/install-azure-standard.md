...
This command will install the latest available patch version of Astronomer Software v0.27. To override latest and specify a patch, add it to the `--version=` flag in the format of `0.27.x`. To install Astronomer Software v0.27.0, for example, specify `--version=0.27.0`. For information on all available patch versions, refer to [Software Release Notes](release-notes.md).
