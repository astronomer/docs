...
As of Astronomer v0.8, the Software UI allows you to look up and search Apache Airflow® logs emitted by your Webserver, Scheduler and Worker(s) for any deployment you have access to.
