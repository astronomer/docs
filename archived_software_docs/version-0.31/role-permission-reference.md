...
A root user is assigned all available Astronomer Software permissions. There can only be one root user for each Software installation. See [Manage the root user](https://www.astronomer.io/docs/software/0.31/manage-root-user#log-in-as-the-root-user).
