...
<!-- ARCHIVED - DO NOT MAKE UPDATES TO THIS DOC OR PUBLISH -->
...
Now that you have an EKS cluster set up and your `values.yaml` file defined, you're ready to deploy all components of our platform.
