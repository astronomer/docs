...
You can use the Astro CLI to push build and push images from a Kubernetes cluster to your custom registry. Astronomer Software automatically recognizes that you pushed the image and pulls the image from the custom registry onto your Deployment.
