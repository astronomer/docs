...
| Subcommand | Usage                                                                                                                                              |
| ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| `login`    | To log in to Astro, run `astro login`. For Software, run `astro login <base-domain>`.    |
| `logout`   | To log out of Astro, run `astro logout`. For Software, run `astro logout <base-domain>`. |
...
Run `astro context <subcommand>` in your terminal to see or access available Software installations.

### Subcommands

| Subcommand | Usage                                                                                                                                                                                                                                              |
| ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `list`     | Run `astro context list` to retrieve a list of all installations to which you've previously authenticated.                                                                                                                                            |
| `switch`   | Run `astro context switch` to retrieve a list of available installations, then enter the ID number of the installation you want to switch to. Once that command is successful, authenticate to that installation by running `astro login <base-domain>`. |
| `delete`   | Run `astro context delete <domain>` to delete any locally stored information related to a given installation. Add the `--force` flag to automatically accept any prompts generated by the CLI when you run this command. |
...
`astro workspace create --label=<new-workspace-name> [flags]`

### Flags

| Flag     | Value Type | Usage                                  |
| -------- | ---------- | -------------------------------------- |
| `--name` (_required_) | String     | The name for the new Workspace. |
