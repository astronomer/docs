...
1. In your `values.yaml` file, copy the complete `podTemplate` configuration from your version of the [Astronomer Apache Airflow® Helm chart](https://github.com/astronomer/airflow-chart/blob/master/values.yaml). Your file should look like the following:
