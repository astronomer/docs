...
| `AIRFLOW__LOGGING__REMOTE_LOG_CONN_ID`       | Connection ID of the connection that provides access to your remote logging location                                            | `<connection-name>`                                        |
| `AIRFLOW__LOGGING__LOGGING_CONFIG_CLASS`     | The class name that specifies the logging configuration                                                                         |`astronomer.runtime.logging.logging_config`                |
