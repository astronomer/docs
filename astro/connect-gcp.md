...
To use this solution, make sure Astro can connect to the DNS server using a VPC peering or VPN connection and then submit a request to [Astronomer support](https://cloud.astronomer.io/open-support-request). With your request, include the following information:
