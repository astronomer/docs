...
For advanced Deployment resource configurations, see [Manage Apache Airflow® executors on Astro](executors-overview.md) and [Configure worker queues](configure-worker-queues.mdx).
