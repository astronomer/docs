---
sidebar_label: "From Amazon MWAA"
title: "Migrate to Astro from Amazon MWAA"
id: migrate-mwaa
description: Get started on Astro Hosted by migrating your Apache Airflow® code from Amazon Managed Workflows for Apache Airflow (MWAA).
---
...
Migrate your [Apache Airflow®](https://airflow.apache.org) environment from [Amazon Managed Workflows for Apache Airflow (MWAA)](https://aws.amazon.com/managed-workflows-for-apache-airflow/resources/) to Astro.
...
The Starship migration utility works as a [plugin](https://github.com/astronomer/starship/tree/master/astronomer-starship) with a user interface, or as an [Airflow operator](https://astronomer.github.io/starship/operator/) if you are migrating from a more restricted Airflow environment.
...
## Step 4: Use Starship to Migrate Apache Airflow® Connections and Variables
