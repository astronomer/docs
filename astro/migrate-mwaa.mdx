...
Migrate your Airflow environment from [Amazon Managed Workflows for Apache Airflow (MWAA)](https://cloud.google.com/composer/docs/concepts/overview) to Astro.
...
(Optional) You can use the [AWS CLI](https://aws.amazon.com/cli/) to expedite some of the following steps in this guide.
...
### Install Starship to your MWAA instance as a plugin:
...
### (Optional) Complete Astronomer Starship installation from command line
...
4. If you used the [`plugins` folder](https://cloud.google.com/composer/docs/concepts/cloud-storage#folders_in_the_bucket) in your MWAA project, copy the contents of this folder from your source control platform or S3 to your Astro project `/plugins` folder.
...
The core migration of your project is now complete. Read the following pages to decide whether you need to set up any additional infrastructure on Astro before you cut over your DAGs. 
...
Your migrated Airflow variables and connections are not available locally. You must deploy your project to Astro to test these resources. 
