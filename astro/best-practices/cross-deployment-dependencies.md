...
1. In the deployment you did **not** get your token from (your upstream deployment) use Variables in Astro to create an environment variable for your API token and use `API_TOKEN` for the key.
