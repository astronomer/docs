...
1. In your upstream Deployment, which is the Deployment  for which you did **not** create an API Token, use **Variables** in the Astro UI to create an environment variable for your API token, and use `API_KEY` for the key.
