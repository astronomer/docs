...
4. In the Git repository for your Astro project, define a multi-branch CI/CD pipeline for deploying to Astro. For an example of how to do this in GitHub, see the [Astro Github integration](deploy-github-integration.md).
