...
- User-supplied `airflow.cfg` files are no longer valid in Astro projects. [Environment variables](env-vars-overview.md) are now the only valid method for setting Airflow configuration options.
