...
- Fixed an issue in how a task instance's `log_url` was generated by Airflow to use string concatenation instead of `urljoin`. ([#33063](https://github.com/apache/airflow/pull/33063)) 

### Additional improvements

- Upgraded `astronomer-providers` to 1.17.3
- Upgraded `astro-sdk-python` to 1.6.2
