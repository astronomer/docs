...
Cluster modifications typically take only a few minutes to complete and don't require downtime. In these cases, the Astro UI and [Apache Airflow®](https://airflow.apache.org) UI continue to be available and your Airflow tasks are not interrupted.
