...
<<<<<<< Updated upstream
| [Cloud SQL for PostgreSQL](https://cloud.google.com/sql/docs/postgres)                               | The Cloud SQL instance is the primary database for the Astro data plane. It hosts the metadata database for each Airflow Deployment hosted on the GKE cluster. All Cloud SQL instances are multi-AZ.                                                                                                                          | 1x regional instance with 4 vCPUs, 16GB memory                                             |                                                                                  |
=======
| [Cloud SQL for PostgreSQL](https://cloud.google.com/sql/docs/postgres)                               | The Cloud SQL instance is the primary database for the Astro data plane. It hosts the metadata database for each Airflow Deployment hosted on the GKE cluster.                                                                                                                            | 1x regional instance with 4 vCPUs, 16GB memory                                             | Yes. See [Configure your database instance type](modify-cluster.md#configure-a-database-instance-type). |
>>>>>>> Stashed changes
