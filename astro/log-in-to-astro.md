...
1. Run the following command to view a list of Astronomer base domains that you have access to. The base domain that is highlighted in green is your current context.
