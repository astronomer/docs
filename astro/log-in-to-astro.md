...
2. Select one of the following options to access the Cloud UI:
    ...
    - Enter your password and click **Continue**. With this log in option, your Organization Owner sends an email invitation to you. Your role is set by the Organization Owner.
    ...
    - To authenticate with your GitHub account, click **Continue with GitHub**, enter your username or email address, enter your password, and then click **Sign in**. With this log in option, your Organization Owner sends an email invitation to you. You can't access the Organization without an invitation.
    - To authenticate with your Google account, click **Continue with Google**, choose an account, enter your username and password, and then click **Sign In**. With this log in option, your Organization Owner sends an email invitation to you. You can't access the Organization without an invitation.
