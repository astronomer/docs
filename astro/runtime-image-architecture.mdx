...
Astro Runtime is a production ready, data orchestration tool based on [Apache Airflow®](https://airflow.apache.org) that is distributed as a Docker image and is required by all Astronomer products. It is intended to provide organizations with improved functionality, reliability, efficiency, and performance.
