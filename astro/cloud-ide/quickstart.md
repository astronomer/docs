...
When you run a cell, The Astro Cloud IDE creates a temporary DAG that executes only individual cell. Astro runs this DAG in your cloud and sends information about the cell run directly to the Astro IDE.
