...
- [cURL](https://curl.se/) or [requests](https://docs.python-requests.org/en/latest/index.html)
...
Using the [`requests`](https://docs.python-requests.org/en/latest/index.html) library:
```
