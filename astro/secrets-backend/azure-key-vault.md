...
# Locate your client ID in Azure Portal under App Registration page > 'Application (Client) ID'
# Locate your tenant ID in Azure Portal under App Registration page > 'Directory (tenant) ID'
# Locate your client secret in Azure Portal under App Registration Page > Certificates and Secrets > Client Secrets > 'Value'
