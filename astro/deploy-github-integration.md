...
<img src={require("../static/img/docs/github-integration-map.png").default} alt="A diagram showing how branches in a GitHub repository directly correlate to specific Deployments in an Astro Workspace." style={{ width: "60%", maxWidth: "400px", height: "auto" }} />
...
<img src={require("../static/img/docs/github-integration-deploy.png").default} alt="A diagram showing how when an engineer commits code to a branch, then after merging the branch to GitHub, the Astro project updates." style={{ width: "60%", maxWidth: "400px", height: "auto" }} />
