...
To test Airflow API calls in a local Airflow environment running with the Astro CLI, see [Troubleshoot your local Airflow environment](cli/troubleshoot-your-local-airflow-environment.md).
