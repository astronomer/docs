...
2. Copy everything up to but not including the `?` in the output generated by the command. This is the Deployment URL you will use to access the Airflow API.
