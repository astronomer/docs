...
If you've already copied task logs or [Apache Airflow®](https://airflow.apache.org) component logs, send them as a part of your request. The more context you can provide, the better.
