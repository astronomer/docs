...
| --------------------- | ---------------------------------------------------------------------------------------------------------------------- | --------------- |
| `-l`, `--login-link`  | The CLI will provide you with a URL to the log in page of the Astro UI instead of automatically opening your browser. Use this link to manually authenticate | None            |
