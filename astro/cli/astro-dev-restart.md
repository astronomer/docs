...
description: Restart a local Apache Airflow® environment.
...
Stop your [Apache Airflow®](https://airflow.apache.org/) environment, rebuild your Astro project into a Docker image, and restart your Airflow environment with the new Docker image.
