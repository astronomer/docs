...
If you want to run your first DAG, but don't want to install any software locally, you can instead use a no-code process and run an example DAG using [GitHub Actions](astro-no-code-onboarding.md).
