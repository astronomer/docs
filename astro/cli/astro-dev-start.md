...
| `-deployment-id`        | Specifies a Deployment whose Environment Configurations you want to use locally. When Airflow builds locally, Astro populates the Airflow metadata database with the Deployment configurations specified in the Cloud UI.                                          | Any valid Deployment ID                                                             |
...
| `-workspace-id`         | Specifies a Workspace whose Environment Configurations you want to use locally. When Airflow builds locally, Astro populates the Airflow metadata database with the configurations specified in the Cloud UI that are applied to all Deployments in the Workspace. | Any valid Workspace ID                                                              |
