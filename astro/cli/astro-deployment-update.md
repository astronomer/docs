...
| `-c`, `--cicd-enforcement`           | Specify that the Deployment can only accept code deploys from API tokens and keys. Note that in CLI versions before 1.23, this flag was `--enforce-cicd`.                            | None                                                                                                                                                                                                                                |
