...
|
| `--deployment-file`            | A location of the Deployment file to update the Deployment with. The file format can be JSON or YAML. See [Create a Deployment with a Deployment File](manage-deployments-as-code.md). | A valid file path to any YAML or JSON Deployment file                                                                                                                                                                               |
...
| `--scheduler-size` | The size of the Scheduler for the Deployment. | Possible values can be `small`, `medium`, or `large`. |
