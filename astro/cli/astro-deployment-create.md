...
| `--default-task-pod-cpu`         | The default task pod CPU to use for the Deployment. See [Customize a task's Kubernetes Pod](kubernetes-executor.md#customize-a-tasks-kubernetes-pod) for more information. |    A numeric value such as `0.25`. This number cannot exceed the values you configured in your [Default pod resources](deployment-resource.md#configure-kubernetes-pod-resources) in the UI or in your Deployment Configuration file.                                                    |
| `--default-task-pod-memory`         | The default task pod memory to use for the Deployment. See [Customize a task's Kubernetes Pod](kubernetes-executor.md#customize-a-tasks-kubernetes-pod) for more information. |   A numeric value such as `0.5Gi`. This number cannot exceed the values you configured in your [Default pod resources](deployment-resource.md#configure-kubernetes-pod-resources) in the UI or in your Deployment Configuration file.                               |
...
| `--resource-quota-cpu`         | The Deployment's CPU resource quota. See [Customize a task's Kubernetes Pod](kubernetes-executor.md#customize-a-tasks-kubernetes-pod) for more information. |    A numeric value such as `10`. This number cannot exceed the values you configured in your [Default pod resources](deployment-resource.md#configure-kubernetes-pod-resources) in the UI or in your Deployment Configuration file.                                                    |
