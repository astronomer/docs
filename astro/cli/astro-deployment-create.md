...
| `--default-task-pod-cpu`         | (Astro Hosted only) The default task pod CPU to use for the Deployment. See [Customize a task's Kubernetes Pod](kubernetes-executor.md#customize-a-tasks-kubernetes-pod) for more information. |    A numeric value such as `0.25`. This number cannot exceed the values you configured in your [Default pod resources](deployment-resource.md#configure-kubernetes-pod-resources) in the UI or in your Deployment Configuration file.                                                    |
| `--default-task-pod-memory`         | (Astro Hosted only) The default task pod memory to use for the Deployment. See [Customize a task's Kubernetes Pod](kubernetes-executor.md#customize-a-tasks-kubernetes-pod) for more information. |   A numeric value such as `0.5Gi`. This number cannot exceed the values you configured in your [Default pod resources](deployment-resource.md#configure-kubernetes-pod-resources) in the UI or in your Deployment Configuration file.                               |
...
| `--region`                  | (Astro Hosted only) The region where you want to host the Deployment.                                                                                                                                                                                      | The code for any [supported region](resource-reference-hosted.md#standard-cluster-regions)                                         |
| `--resource-quota-cpu`         | (Astro Hosted only) The Deployment's CPU resource quota. See [Customize a task's Kubernetes Pod](kubernetes-executor.md#customize-a-tasks-kubernetes-pod) for more information. |    A numeric value such as `10`. This number cannot exceed the values you configured in your [Default pod resources](deployment-resource.md#configure-kubernetes-pod-resources) in the UI or in your [Deployment file](deployment-file-reference.md) configuration. file.                                                    |
| `--resource-quota-memory`         | (Astro Hosted only) The Deployment's memory resource quota. See [Customize a task's Kubernetes Pod](kubernetes-executor.md#customize-a-tasks-kubernetes-pod) for more information. |    A numeric value such as `20Gi`. This number cannot exceed the values you configured in your [Default pod resources](deployment-resource.md#configure-kubernetes-pod-resources) in the UI or in your [Deployment file](deployment-file-reference.md) configuration. file.                                                    |
...
| `--wait`                    | Wait for the new Deployment to have a [healthy](deployment-health-incidents.md) status before completing the command                                                                                                                                       | None                                                                                                                               |
