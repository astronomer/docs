...
| `--region`                  | (Astro Hosted only) The region where you want to host the Deployment.                                                                                                                                                                                       | The code for any [supported region](resource-reference-hosted.mdx#standard-cluster-regions)                                                                                                                                                                                                 |
...
| `-t`,`--triggerer-replicas`   | Number of replicas to use for the Apache Airflow® triggerer                                                                                                                | Any integer between 0 - 2. The default value is 1.                                                                                 |
| `--workspace-id`              | The Workspace in which to create a Deployment. If not specified, your current Workspace is assumed                                                                 | Any valid Workspace ID                                                                                                              |
