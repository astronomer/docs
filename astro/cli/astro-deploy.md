...
| `--image`                 | If you have DAGs-only deploys enabled, use this flag to only deploy your Astro project image. When you use this option, it does not add update your DAGs folder. | None                                                             |
