...
You can use `astro organization user invite` to invite multiple users at once to an Organization. See [Add a group of users to Astro using the Astro CLI](add-user.md#add-a-group-of-users-to-astro-using-the-astro-cli).
