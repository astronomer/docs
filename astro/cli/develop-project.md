...
An Astro project contains all of the files necessary to test and run DAGs in a local [Apache Airflow®](https://airflow.apache.org) environment and on Astro. This guide provides information about adding and organizing Astro project files, including:
