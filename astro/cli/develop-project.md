...
- Use the Cloud UI to create connections that can be shared across Deployments in a Workspace. These connections are not visible in the Airflow UI. See [Create Airflow connections in the Astro Cloud UI](/astro/create-and-link-connections.md) for more information.
