...
Create a [worker queue](configure-worker-queues.md) on for a Deployment on Astro. This command is functionally identical to creating a worker queue in the Cloud UI.
