...
6. Wait for Astronomer support to send you the Astro VPC CIDR and VPC Peering ID. Then, the owner of the accepter VPC needs to [create back routes entries](https://docs.aws.amazon.com/vpc/latest/userguide/WorkWithRouteTables.html#AddRemoveRoutes) in the accepter VPC, with the Astro VPC CIDR as the **Destination** and the provided VPC Peering ID as the **Target**.
