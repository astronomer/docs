...
To access a service in a different region using PrivateLink endpoints, you can use an inter-Region VPC peering connection. You create the inter-Region VPC peering connection in the same region as the targeted service, and then you create the PrivateLink service endpoint in the VPC.
