...
- Prepare a list of the AWS Services which require Endpoints (e.g. SQS, Lambda, DynamoDB).
- Contact [Astronomer support](https://cloud.astronomer.io/open-support-request) and provide this information for the further steps.
...
- Open a list of your clusters in [Cloud UI](https://cloud.astronomer.io/clusters).
