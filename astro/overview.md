...
<LinkCardGrid>
  ...
  <LinkCard label="I'm ready to create my first project" description="Learn how to create an Astro project and run it locally with the Astro command-line interface (CLI)." href="/astro/create-dag" icon="/img/astro-monogram.svg" />
</LinkCardGrid>
