...
- Test all project changes locally with the Astro CLI. See [Test your Astro project locally](cli/test-your-astro-project-locally.md) and [Troubleshoot your local Apache Airflow® environment](cli/run-airflow-locally.md).
