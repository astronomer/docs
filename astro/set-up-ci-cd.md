...
There are many strategies for organizing your source code and building CI/CD pipelines for [Apache Airflow®](https://airflow.apache.org) on Astro, and each has its own benefits and limitations. Use this document to:
