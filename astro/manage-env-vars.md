...
6. Click **Update Environment Variables** to save your changes. Your [Apache Airflow®](https://airflow.apache.org) scheduler, webserver, and workers restart. After saving, it can take up to two minutes for new variables to be applied to your Deployment.
