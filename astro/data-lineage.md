...
If you have either a [Great Expectations](https://docs.greatexpectations.io/docs/) integration or use the `SQLTableCheckOperator` or `SQLColumnCheckOpertor`, this tab also contains charts that show success and failures of data quality checks.
