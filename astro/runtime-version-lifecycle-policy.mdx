...
<<<<<<< HEAD:software/runtime-version-lifecycle-policy.md
...
>>>>>>> 4d74812f48985d721113075b5a1b1415f2842ed7:astro/runtime-version-lifecycle-policy.mdx
...
There are some restricted versions of the Astro runtime that have known bugs, and cannot be used, even if you have [Running a deprecated Astro Runtime version](https://docs.astronomer.io/astro/upgrade-runtime#run-a-deprecated-astro-runtime-version) enabled. These invalid versions of the Astro Runtime have a status `"yanked":true` if you query `https://updates.astronomer.io/astronomer-runtime` and include a description about why the version is unavailable.
