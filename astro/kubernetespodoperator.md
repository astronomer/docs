...
- There is a known incompatibility with [Astro Runtime Version 8.0.0](upgrade-runtime.md#kubernetespodoperators-and-runtime-810). Make sure you do not use that version by checking your Dockerfile configuration.
