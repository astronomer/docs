...
- ARM images are not supported in the KubernetesPodOperator. To build images using the AMD platform on your Mac with Apple chip, add the `--platform` flag in the `FROM` command of your `Dockerfile`. For example:
