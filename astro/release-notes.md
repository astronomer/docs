...
You can now keep teams and projects isolated by authorizing Workspaces to specific clusters. After you enable Workspace authorization for a cluster, only authorized Workspaces can host Deployments in the cluster. Use this feature to better manage cloud resources by ensuring that only authorized Deployments are running on specific clusters.
