...
If it's your first time deploying, you'll need to wait a few minutes for the Docker image to build. The Docker image that is running on the Airflow webserver of your Deployment is shown in a tag in the Airflow UI footer. Depending on how your organization deploys to Astro, this tag is either a unique identifier generated by a Continuous Integration (CI) tool or a timestamp generated by the Astro CLI on astro deploy. Both represent a unique version of your Astro project.
