...
To configure Airflow notifications, see [Airflow email notifications](airflow-alerts.md) and [Manage Airflow DAG notifications](error-notifications-in-airflow.md)
