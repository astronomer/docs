...
2.  Adjust the template file values for the Deployment you want to create. When working with template files, keep the following in mind:
    ...
    - See [Apache Airflow® and Astro Runtime version parity](runtime-image-architecture.mdx#astro-runtime-and-apache-airflow-parity) to choose your Astro Runtime version.
