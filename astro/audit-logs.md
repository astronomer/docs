...
- **Apache Airflow® UI access**: The data generated when users access the Airflow UI.
...
### Apache Airflow® UI access event fields

The following table lists the fields that are unique to Airflow UI access events.

#### Table: Apache Airflow® UI access event fields
