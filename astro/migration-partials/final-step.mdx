...
With the deployment successfully deployed to Astro Cloud, the migration is completed by fully shifting
our workloads from the source Airflow to our Astro Airflow. We will do this DAG-by-DAG.
...
<details>
    <img src="https://github.com/astronomer/starship/raw/master/astronomer-starship/images/cutover-tab.png"></img>
</details>

2. In the table displaying the DAGs present in both the source and target environments, click the Pause icon under `Loca`l
<details>
    <img src="https://github.com/astronomer/starship/raw/master/astronomer-starship/images/cutover-pause-local.png"></img>
</details>

3. In the table displaying the DAGs present in both the source and target environments, click the Start icon under `Remot`e
<details>
    <img src="https://github.com/astronomer/starship/raw/master/astronomer-starship/images/cutover-start-remote.png"></img>
</details>
...
<details>
    <img src="https://github.com/astronomer/starship/raw/master/astronomer-starship/images/cutover-complete.png"></img>
</details>
...
#### DAGs-only Deploy
The DAGs-only deployment mechanism can be utilized to deploy DAG code changes faster - in instances where you have not modified your `Dockerfile`, `requirements.txt`, or `packages.txt` files.
You can read more about enabling [DAGs-only deploys here](deploy-code.md#deploy-dags-only)
