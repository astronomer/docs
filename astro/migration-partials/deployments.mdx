...
6. Set an email to receive alerts from Astronomer support about your Deployments. See [Add Or Delete A Deployment Alert Email](deployment-settings.md#configure-deployment-contact-emails).
...
3. Replace the placeholder values in the configuration:
  ...
  :::
    ...
    - `<alert-email>`: Set an email to receive alerts from Astronomer support about your Deployments. See [Add Or Delete A Deployment Alert Email](deployment-settings.md#configure-deployment-contact-emails).
