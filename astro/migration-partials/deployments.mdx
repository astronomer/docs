...
3. Replace the placeholder values in the configuration:
    ...
    | Airflow Version | Runtime Version       | Note                                                                    |
    |-----------------|-----------------------|-------------------------------------------------------------------------|
    | 2.0             | 3.0.4 (Airflow 2.1.1) | Unsupported. The minimum supported version is Runtime 4.x / Airflow 2.2 |
    | 2.2             | 4.2.9 (Airflow 2.2.5) |                                                                         |
    | 2.4             | 6.3.0 (Airflow 2.4.3) |                                                                         |
    ...
    | Environment size | AUs | CPU / Memory Equivalents | Note                                       |
    |------------------|-----|--------------------------|--------------------------------------------|
    | Small            | 5   | .5vCPU, 1.88GiB          |                                            |
    | Medium           | 10  | 1vCPU, 3.75GiB           | smaller than source Airflow recommendation |
    | Large            | 15  | 1.5vCPU, 5.64GiB         | smaller than source Airflow recommendation |
