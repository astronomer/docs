...
3. Complete the following fields:
   ...
   >*The earliest supported Airflow version on Astro Runtime is 2.1.1. There are no known risks for upgrading directly from Airflow 2.0 to Airflow 2.1.1 during migration. 
...
3. Replace the placeholder values in the configuration:
   ...
   Some of the following recommendations for CPU and memory are smaller than what you would have in an equivalent GCC/ MWAA source environment. Although you shouldn't need any more CPU or memory than what's recommended here, some environments might parse DAGs slower than in your source Airflow environment to start. Use these recommendations as a starting point, then adjust your resource usage after tracking your performance on Astro.
