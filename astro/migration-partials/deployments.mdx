...
6. Set an email to receive alerts from Astronomer support about your Deployments. See [Configure Deployment contact emails](deployment-details.md#configure-deployment-contact-emails).
...
3. Replace the placeholder values in the configuration:
  ...
  :::
    ...
    - `<alert-email>`: Set an email to receive alerts from Astronomer support about your Deployments. See [Set up Astro alerts](alerts.md).
