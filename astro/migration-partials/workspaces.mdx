...
2. Follow the steps in [Manage Astro users](manage-workspace-users.md#add-a-user-to-a-workspace) to add users from your team to the Workspace. See [Astro user permissions](user-permissions.md#workspace-roles) for details about each available Workspace user role.
...
You can automate adding batches of users to Astro with shell scripts. See [Add a group of users to Astro using the Astro CLI](manage-workspace-users.md#add-a-group-of-users-to-a-workspace-using-the-astro-cli).
