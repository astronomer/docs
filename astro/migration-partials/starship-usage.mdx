...
1. After installing `astronomer-starship`, you will see a new Astronomer menu. Hover over that menu and select the `Migration Tool 🚀` option
<details>
    <img src="https://github.com/astronomer/starship/raw/master/astronomer-starship/images/menu-item.png"></img>
</details>

2. After opening the plugin page, authenticate to Astronomer. To do this, please:
...
3. After authenticating to Astronomer, select the deployment that you are sending metadata to by selecting a deployment from the `Target Deployment` dropdown and clicking the `Select` button
...
To migrate variables from your source Airflow metadata database:
