...
For information about creating an Astro project, see [Create an Astro project](create-dag.md#step-1-create-an-astro-project). For information about adding DAGs to your Astro project and applying changes, see [Develop a project](develop-project.md).
