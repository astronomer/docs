...
Use the following CI/CD templates to automate deploying [Apache Airflow®](https://airflow.apache.org/) DAGs from a Git repository to Astro with [Bitbucket](https://bitbucket.org/product).
