...
| [RDS for PostgreSQL Instance](https://aws.amazon.com/rds/)                                          | The multi-AZ RDS instance is the primary database of the Astro data plane. It hosts a metadata database for each Deployment in the cluster.                                                                                                                                                                                                                       | 1x db.m6g.large                                | Yes. See [Configure your relational database](modify-cluster.md#configure-your-relational-database). |
