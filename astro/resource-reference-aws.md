...
| [VPC](https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html)                     | Virtual network for launching and hosting AWS resources.                                                                                                                                                                                                                                                                                                 | 1x /19                                        | Yes. See [Connect Astro to AWS data sources](connect-aws.md).                                        |
| [VPC Interface Endpoints](https://docs.aws.amazon.com/whitepapers/latest/aws-privatelink/what-are-vpc-endpoints.html#interface-endpoints)                     | Enable connectivity to elasticloadbalancing, autoscaling-plans, sts, ecr.dkr, and ecr.api services over AWS PrivateLink                                                                                                                                                                        | 5x                                            |                                                                                                      |
| [Amazon S3](https://docs.aws.amazon.com/AmazonS3/latest/userguide//Welcome.html)                    | Stores Airflow task logs.                                                                                                                                                                                                                                                                                                                                | 1x                                            |                                                                                                      |
| [S3 Gateway Endpoint](https://docs.aws.amazon.com/whitepapers/latest/aws-privatelink/what-are-vpc-endpoints.html#gateway-endpoints)                    | IP routes used for traffic destined to Amazon Simple Storage Service (Amazon S3)                                                                                                                                                                                                                      | 1x                                            |                                                                                                      |
