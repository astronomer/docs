...
| Max Node Count | The maximum number of data nodes that your Astro Cluster can support at any given time. Once this limit is reached, your Cluster cannot auto-scale and pods may fail to schedule. | 20 |
