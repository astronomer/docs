...
The **Usage** page shows the total number of task runs across all Deployments in your Organization. To access the **Usage** page, click your Workspace name in the upper left corner of the Cloud UI and click **Organization Settings**. Then, click **Usage**.
