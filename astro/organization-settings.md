...
When members of your Organization create a local Apache Airflow® environment using the Astro CLI, they can pull connections configured in the [Astro Environment Manager](create-and-link-connections.md) based on their Workspace credentials. This enables users to share connection details between Astro and their local Airflow environments and avoid creating connections twice. See [Import and export Apache Airflow® connections and variables](cli/local-connections.md) for more details.
