...
- [CI/CD templates](ci-cd-templates/templates-overview.md)

Similarly to GCC, you can deploy DAGs to Astro directly from a Google Cloud Storage (GCS) bucket. See [CI/CD templates](ci-cd-templates/gcs.md).
