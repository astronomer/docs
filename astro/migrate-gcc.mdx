...
id: migrate-gcc
description: Get started on Astro by migrating your Apache Airflow® code from Google Cloud Composer (GCC).
---
...
This is where you'll find instructions for migrating an [Apache Airflow®](https://airflow.apache.org) environment from [Google Cloud Composer (GCC)](https://cloud.google.com/composer/docs/concepts/overview) to Astro.
