...
![A screenshot of the streamlit application created in this use case that shows the customer analytics dashboard](./static/img/use_case_images/snowpark_weaviate_use_case/use-case-snowpark_weaviate_ca_dag_2.png)
