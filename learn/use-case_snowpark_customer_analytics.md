...
![A screenshot of the streamlit application created in this use case that shows the customer analytics dashboard](../static/img/use_case_images/use-case-snowpark_weaviate_streamlitdashboardss1.png)
