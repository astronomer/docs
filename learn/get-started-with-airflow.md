...
pagination_next: get-started-with-airflow-part-2
---
...
- Navigate the [Apache Airflow® UI](airflow-ui.md).
...
- `/dags`: A directory of DAG files. Each Astro project includes an example DAG called `example_astronauts`. For more information on DAGs, see [Introduction to Apache Airflow® DAGs](dags.md).
...
The [Apache Airflow® UI](airflow-ui.md) is essential for managing Airflow. It contains information about your DAGs and is the best place to create and update Airflow connections to third-party data services.
...
![Screenshot of the DAGs page of the Apache Airflow® UI showing the example_astronauts DAG with no run history yet.](/img/tutorials/get-started-with-airflow_ui_with_starter_dags.png)
...
1. Before you can trigger a DAG run in Airflow, you have to unpause the DAG. To unpause `example_astronauts`, click the slider button next to its name. Once you unpause it, the DAG starts to run on the schedule defined in its code.
    ...
    ![Screenshot of the DAGs view of the Apache Airflow® UI with an arrow pointing to the toggle on the right side of the DAG name you can click to unpause the DAG.](/img/tutorials/get-started-with-airflow_unpause_dag.png)
...
![Screenshot of the DAGs view of the Apache Airflow® UI showing the unpaused example_astronauts DAG with one previous successful DAG run and one run currently in progress.](/img/tutorials/get-started-with-airflow_dag_running.png)
...
The navigation bar in the Airflow UI contains tabs with different information about your Airflow environment. For more information about what you can find in each tab, see [The Apache Airflow® UI](airflow-ui.md).
...
1. Click the name of the DAG to access the **Grid** view, which shows the status of running and completed tasks.
    ...
    ![Screenshot of the Apache Airflow® Grid view showing two DAG runs of the example_astronauts DAG.](/img/tutorials/get-started-with-airflow_grid_view.png)
...
2. Click the name of your new DAG and open the **Grid** view. After your DAG runs, there should be a green bar representing a successful run of the DAG.
    ...
    ![Screenshot of the Apache Airflow® Grid view showing a successful run of the my_astronauts_dag DAG.](/img/tutorials/get-started-with-airflow_grid_view_my_astronauts_dag.png)
...
- [An introduction to the Apache Airflow® UI](airflow-ui.md)
- [Introduction to Apache Airflow® DAGs](dags.md)
- [Apache Airflow® operators](what-is-an-operator.md)
- [Introduction to the TaskFlow API and Apache Airflow® decorators](airflow-decorators.md)
- [Datasets and data-aware scheduling in Apache Airflow®](airflow-datasets.md)
- [Pass data between tasks](airflow-passing-data-between-tasks.md)
- [Manage task and task group dependencies in Apache Airflow®](managing-dependencies.md)
- [Create dynamic Apache Airflow® tasks](dynamic-tasks.md)