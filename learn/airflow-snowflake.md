...
2. Create a new connection and enter `snowflake_default` in the Connection Id field, and choose the `Snowflake` connection type. Enter the following information:
