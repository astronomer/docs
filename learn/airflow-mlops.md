...
- **Extensible**: Airflow itself is written in Python as well, which makes it easy to extend it with [customer modules](airflow-importing-custom-hooks-operators.md) and [Airflow plugins](using-airflow-plugins.md).
