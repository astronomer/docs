...
- **Incremental and idempotent pipelines**: Airflow allows you to define pipelines that operate on data collected in a specified timeframe and to perform [backfills and reruns](rerunning-dags.md#backfill) of a set of idempotent tasks. This lends itself well to creating features stores, especially for time-dimensioned features, which form the basis of advanced model training and selection.
