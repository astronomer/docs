...
- **Extensible**: Airflow itself is written in Python, which makes it easy to extend with [custom modules](airflow-importing-custom-hooks-operators.md) and [Airflow plugins](using-airflow-plugins.md).
