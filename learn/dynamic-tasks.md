...
<img src={require("../static/img/guides/dynamic-tasks-graph_tab_simple.png").default} alt="Screenshot of the Graph tab in the Airflow UI Grid view showing a DAG run graph with two tasks, the latter having been mapped 49 times." style={{ width: "60%", maxWidth: "400px", height: "auto" }} />
