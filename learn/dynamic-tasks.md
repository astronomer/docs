...
- You can limit the number of mapped task instances for a particular task that run in parallel by setting one or both of two parameters in your dynamically mapped task:
