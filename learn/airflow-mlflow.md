...
If you have connection testing from the UI enabled, please note that the **Test** button might return a 405 error message even if your credentials are correct. 
