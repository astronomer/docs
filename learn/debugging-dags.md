...
- Use the test connection feature added in Airflow 2.2 that many connection types have available. In Airflow 2.6+ you can test connections from the CLI using the [`airflow connections test`](https://airflow.apache.org/docs/apache-airflow/stable/cli-and-env-variables-ref.html#test) command. See also [Testing connections](connections.md#testing-connections)
