...
- Set up storage in your [custom XCom backend](airflow-custom-xcom-backend.md) to hold data processed through Airflow tasks, then tear the extra storage down afterwards when the XCom data is no longer needed. 
