...
If you are not using Astro, to start a triggerer process run `airflow triggerer` in your Airflow environment. Your output should be similar to the following image.
