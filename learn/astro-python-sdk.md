...
3. Set the following environment variables to configure your database to store temporary tables generated by the SDK. If you're using the Astro CLI, add these environment variables to the `.env` file of your Astro project:
