...
- An [Astro account](https://docs.astronomer.io/astro/log-in-to-astro). 
- An [Organization API token](https://docs.astronomer.io/astro/organization-api-tokens) with the Organization Owner role. Astronomer recommends that you create a new API token for this tutorial.
- An Astro [Workspace](https://docs.astronomer.io/astro/manage-workspaces).
