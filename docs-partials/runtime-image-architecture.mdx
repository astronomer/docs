...
You can modify this image tag in your Astro project Dockerfile to use different versions of Astro Runtime. The following sections explain each distribution type and how to specify them. For a list of all Astro Runtime Docker images, see [Quay.io](https://quay.io/repository/astronomer/astro-runtime?tab=tags).
