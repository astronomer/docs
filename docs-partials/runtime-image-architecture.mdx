...
For example, to find the version of the current package for OpenLineage, run the following command:

```
astro dev bash pip freeze | grep apache-airflow-providers-openlineage
```
